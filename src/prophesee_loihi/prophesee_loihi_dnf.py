...
class Architecture:
   ...
   def plot(self):
      ...
      anim = matplotlib.animation.FuncAnimation(self.fig, self.update_gauss, interval=15, frames=self.time_steps, blit=True)
      #plt.show()
      anim.save('/home/altair/Postdoc/selctive_dnf.mp4', writer = 'ffmpeg', fps = 30)
